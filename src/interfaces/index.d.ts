...
const typeMap: any = {
    "Welcome": o([
        { json: "YhZav", js: "YhZav", typ: r("YhZav") },
    ], false),
    "YhZav": o([
        { json: "Year", js: "Year", typ: "" },
        { json: "Week", js: "Week", typ: "" },
        { json: "Numerator", js: "Numerator", typ: "" },
        { json: "Monday", js: "Monday", typ: "" },
        { json: "Work", js: "Work", typ: "" },
    ...
    "Timetable": o([
        { json: "Day", js: "Day", typ: u(a(r("DayElement")), r("DayElement")) },
    ], false),
    "DayElement": o([
        { json: "Lesson", js: "Lesson", typ: a(r("Lesson")) },
        { json: "_N", js: "_N", typ: "" },
    ], false),
    "Lesson": o([
        { json: "Part", js: "Part", typ: u(a(r("PartElement")), r("PartElement")) },
        { json: "_N", js: "_N", typ: "" },
    ], false),
    "PartElement": o([
        { json: "Name", js: "Name", typ: "" },
        { json: "Teacher", js: "Teacher", typ: "" },
        { json: "Auditorium", js: "Auditorium", typ: u(undefined, r("Auditorium")) },
        { json: "_N", js: "_N", typ: "" },
    ], false),
    "Auditorium": o([
        { json: "_Number", js: "_Number", typ: "" },
        { json: "_Building", js: "_Building", typ: r("Building") },
    ], false),
    "Building": [
        "Главный корпус",
    ],
